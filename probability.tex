...
% 
%  A partir de una investigación realizada, se sabe que el 10 % de las personas de 50 años sufren un
...
% positivo.
% b) Si el resultado de aplicar el procedimiento a una persona ha sido positivo, ¿Cuál es la proba-
