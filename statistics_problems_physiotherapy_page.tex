...
\input{questions/descriptive}
\input{questions/regression}
\input{questions/probability}
\input{questions/discrete_random_variables}
\input{questions/continuous_random_variables}
% \input{estimacion}
